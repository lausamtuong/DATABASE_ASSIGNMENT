          ...
          <div data-v-42acd70a="" class="cart-item">
            ...
            <div class="cart__column cart__column-left">
              <div class="cart-item__thumbnail-block">
                <img
                  src={"https://media.coolmate.me/cdn-cgi/image/width=672,height=990,quality=85,format=auto/uploads/October2022/ao-thun-the-thao-dai-tay-recycle-active-den-1.jpg"||props.illustration}
                ...
                <div class="cart-item__actions">
                  <div>
                    ...
                    >
                      ...
                      <div
                        ...
                        role="combobox"
                        aria-expanded="false"
                        aria-owns="vs176__listbox"
                        aria-label="Search for option"
                        class="vs__dropdown-toggle"
                      >
                        <div class="vs__selected-options">
                          <span class="vs__selected">Trắng sọc xanh</span>{" "}
                          <input
                            readonly="readonly"
                            aria-autocomplete="list"
                            aria-labelledby="vs176__combobox"
                            aria-controls="vs176__listbox"
                            type="search"
                            autocomplete="off"
                            class="vs__search"
                          />
                  ...
                  <div class="cart-item__actions-bottom">
                    <div data-v-3e8bcd48="" class="quantity-box">
                      ...
                      <input data-v-3e8bcd48="" type="text" value={props.amount}/>
                      <button
                        data-v-3e8bcd48=""
                    ...
                    <div class="flex flex--column">
                      <span>{props.sell_price}</span> <del>{props.sell_price}</del>
                    </div>
                  </div>
                </div>
              </div>
